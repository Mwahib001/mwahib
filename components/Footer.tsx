...
export default function Footer() {
  ...
  const socialLinks = [
    {
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/muhammad-wahib-85a836227/",
      icon: (
    ...
    // {
    //   name: "Instagram",
    //   url: "https://www.instagram.com/wahib_is_here_/",
    //   icon: (
    //     <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "Email",
      url: "mailto:muhammadwahib001@gmail.com",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
    ...
    {
      name: "GitHub",
      url: "https://github.com/Mwahib001",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-8 sm:px-12 lg:px-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-right">
            <div className="mt-1 pt-1 border-t border-border/20 text-center md:text-right">
              <p className="mb-2">
